...
class LoginActivity : AppCompatActivity() {
    ...
    //OnCompleteListenerは処理の完了を受け取るリスナー
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // アカウント作成処理のリスナーを定義
        // リスナーはaddOnCompleteListenerで呼ばれる
        mCreateAccountListener = OnCompleteListener { task ->
            ...
            if(task.isSuccessful){
                ...
                Log.e("TAG", "onComplete: Failed=" + task.exception);
        ...
        mLoginListener = OnCompleteListener { task ->
            if(task.isSuccessful){
                ...
                // android.R.id.contentでrootのViewが取れるらしい
                val view = findViewById<View>(android.R.id.content)
        ...
        // setOnClickListenerする時はR.id.createButtonとかいらんらしい
